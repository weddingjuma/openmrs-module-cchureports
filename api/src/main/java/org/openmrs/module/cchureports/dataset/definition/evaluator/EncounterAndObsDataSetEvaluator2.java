 ...
 */
package org.openmrs.module.cchureports.dataset.definition.evaluator;
...
/**
 * The logic that evaluates a {@link EncounterAndObsDataSetDefinition2} and produces an
 * {@link DataSet}
 * 
 * @see EncounterAndObsDataSetDefinition2
 */
@Handler(supports = { EncounterAndObsDataSetDefinition2.class }, order = 25)
public class EncounterAndObsDataSetEvaluator2 extends EncounterDataSetEvaluator {
	
	protected static final Log log = LogFactory.getLog(EncounterAndObsDataSetEvaluator2.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext context) throws EvaluationException {
		...
		Concept dateOfProcedure = MetadataLookup.getConcept("3345");
		Concept procedureType = MetadataLookup.getConcept("3232");
		Concept surgeon = MetadataLookup.getConcept("3636");
		Concept assistant = MetadataLookup.getConcept("3639");
		
		List<Concept> obsWeWant = Arrays.asList(dateOfProcedure, procedureType, surgeon, assistant);
		
		EncounterAndObsDataSetDefinition2 dsd = (EncounterAndObsDataSetDefinition2) dataSetDefinition;
